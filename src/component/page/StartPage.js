...
import titleImg from "@/../public/0.start/0.title.svg";
import startBtn from "@/../public/0.start/0.start.svg";
    ...
    <>
      <MobileFrame>
        <div className="flex flex-col justify-center items-center gap-[60px]">
          ...
          <div
            onClick={nextStep}
            className="rounded-2xl w-[100px] h-[40px] bg-[#B65A0F] drop-shadow-[0_4px_0_#8D4509] text-white flex justify-center items-center font-semibold "
          >
            START
          </div>
          <div
